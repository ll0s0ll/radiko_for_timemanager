...
[play_radiko.sh]
https://gist.github.com/ihsoy-s/5292735#file-play_radiko-sh
...
CHANNELS = ['TBS','QRR','LFR','JORF','INT','FMT','FMJ','BAYFM78','NACK5','YFM']
DEFAULT_INTERVAL = 60
...
if __name__ == '__main__':
    ...
    try:
        ...
        cmd = u'echo "0:%d:%s" | tm crontab -r %d "%s" | tm set - && play_radiko.sh %s > /dev/null 2>&1; tm terminate;' % (args.duration, args.caption.decode('utf-8'), args.duration, args.schedule, args.channel)
